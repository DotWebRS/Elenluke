...
builder.Services.AddRateLimiter(options =>
{
    ...
    options.AddPolicy("login-policy", httpContext =>
        RateLimitPartition.GetFixedWindowLimiter(
            partitionKey: httpContext.Connection.RemoteIpAddress?.ToString() ?? "unknown-login",
    ...
    options.AddPolicy("public-form-policy", httpContext =>
        RateLimitPartition.GetFixedWindowLimiter(
            partitionKey: httpContext.Connection.RemoteIpAddress?.ToString() ?? "unknown-form",
            factory: _ => new FixedWindowRateLimiterOptions
            {
                PermitLimit = 10,

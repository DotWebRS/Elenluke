...
export default function Cookies() {
  ...
  const savedMsg = useMemo(() => {
    return lang === "DE" ? "Gespeichert ✅" : "Saved ✅";
  }, [lang]);
            ...
            <div className="cookie__group">
              <div className="cookie__row">
                <label className="cookie__label">
                  ...
                  />
                  <span className="cookie__name">
                    {lang === "DE" ? "Marketing" : "Marketing"}
                  </span>
                </label>
              </div>
          ...
          <div className="modal" role="dialog" aria-modal="true" aria-label="Cookie Policy">
            ...
            <div className="modal__panel">
              <div className="modal__top">
                <div className="modal__title">Cookie Policy</div>
                <button
              ...
              <div className="modal__body">
                <div className="modal__block">
                  ...
                  <div className="modal__p">
                    Diese Cookie-Richtlinie erklärt, wie Purple Media Group („wir“, „uns“) Cookies und ähnliche Technologien auf
                    [www.purplecrunchpublishing.com] einsetzt.
                  </div>

                  <div className="modal__h2">1. Was sind Cookies?</div>
                  <div className="modal__p">
                    Cookies sind kleine Textdateien, die auf Ihrem Endgerät gespeichert werden. Sie helfen, eine Website bereitzustellen,
                    sicher zu betreiben und Funktionen sowie Analysen zu ermöglichen.
                  </div>
                  ...
                  <div className="modal__p">
                    ...
                    Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an einem technisch fehlerfreien Betrieb) und – soweit einschlägig –
                    § 25 Abs. 2 Nr. 2 TTDSG.
                  </div>
                  ...
                  <div className="modal__p">
                    Beim ersten Besuch fragen wir Sie (sofern erforderlich) nach Ihrer Einwilligung. Sie können Ihre Auswahl jederzeit ändern oder widerrufen über:
                    [Link zu Cookie-Einstellungen].
                  </div>

                  <div className="modal__h2">4. Cookies von Drittanbietern</div>
                  <div className="modal__p">
                    Wenn wir Dienste von Drittanbietern einsetzen (z. B. Analyse- oder Marketingtools), können diese eigene Cookies setzen und Daten verarbeiten.
                    Details finden Sie in den Cookie-Einstellungen und in unserer Datenschutzerklärung.
                  </div>

                  <div className="modal__h2">5. Speicherdauer</div>
                  <div className="modal__p">
                    Cookies werden entweder nur für die Sitzung gespeichert (Session Cookies) oder bleiben für eine definierte Zeit auf Ihrem Gerät (Persistente Cookies).
                    Die jeweilige Dauer sehen Sie in den Cookie-Einstellungen.
                  </div>
                </div>
                ...
                <div className="modal__block">
                  ...
                  <div className="modal__p">
                    This Cookie Policy explains how [Company Name] (“we”, “us”) uses cookies and similar technologies on [Domain].
                  </div>
                  ...
                  <div className="modal__p">
                    Required to operate the website (e.g., security, basic functions). Legal basis: Art. 6(1)(f) GDPR and, where applicable, Sec. 25(2) TTDSG.
                  </div>

                  <div className="modal__h3">b) Functional cookies (optional)</div>
                  <div className="modal__p">
                    Enable enhanced functionality and personalization. Legal basis: Consent, Art. 6(1)(a) GDPR + Sec. 25(1) TTDSG.
                  </div>

                  <div className="modal__h3">c) Analytics cookies (optional)</div>
                  <div className="modal__p">
                    Help us understand how visitors use the site. Legal basis: Consent, Art. 6(1)(a) GDPR + Sec. 25(1) TTDSG.
                  </div>

                  <div className="modal__h3">d) Marketing cookies (optional)</div>
                  <div className="modal__p">
                    Used to deliver and measure personalized advertising. Legal basis: Consent, Art. 6(1)(a) GDPR + Sec. 25(1) TTDSG.
                  </div>

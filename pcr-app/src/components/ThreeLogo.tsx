...
renderer.domElement.style.zIndex = "1";
    ...
    loader.load(
      ...
      undefined,
      (err) => console.error("[ThreeLogo] GLB load error:", err)
    );
    ...
    const animate = () => {
      ...
      if (logoRoot) logoRoot.rotation.z = 0; 
    ...
    return () => {
      ...
      if (renderer.domElement.parentNode === wrapper) wrapper.removeChild(renderer.domElement);
    };
  }, []);

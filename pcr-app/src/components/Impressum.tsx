      ...
      <section className="impressum">
        ...
        <div className="impressum__inner">
          <header className="impressum__header">
            <div className="impressum__headerRow">
              <h1 className="impressum__title">Impressum</h1>

              <button
                type="button"
                className="legal__back legal__back--right"
                onClick={() => navigate(-1)}
                aria-label="Go back"
              >
                ← Back
          ...
          <div className="impressum__card">
            ...
            <div className="impressum__section">
              <h3 className="impressum__h3">Inhaltlich verantwortlich (redaktionelle Inhalte)</h3>
              <p className="impressum__p">Inhaltlich verantwortlich gemäß § 18 Abs. 2 MStV:</p>
              <address className="impressum__address">
            ...
            <div className="impressum__section">
              <h3 className="impressum__h3">Verbraucherstreitbeilegung / Schlichtung</h3>
              <p className="impressum__p">
            ...
            <div className="impressum__section">
              <h3 className="impressum__h3">Hinweis zur Online-Streitbeilegung (OS-Plattform)</h3>
              <p className="impressum__p">
                Die EU-Online-Streitbeilegungsplattform (OS) wurde zum 20. Juli 2025 eingestellt;
                eine Verlinkung ist daher nicht mehr erforderlich.
              </p>
            </div>
          </div>
        </div>

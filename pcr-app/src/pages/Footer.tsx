...
export default function Footer({ isActive = true }: Props) {
  ...
  return (
    <section className={cls} style={{ animationDuration: "650ms" }} id="footer">
      <div className="about-bg" aria-hidden="true" />

      <div className="about-content footerPage">
        <Container className="footerCenterWrap">
          <div className="footerCenter">
            <h2 className="about-title about-title-centered footerTitle">
              <span className="about-title-light footerWhite">NOT JUST A LABEL.</span>
              <br />
              <span className="about-us-animated">A MOVEMENT.</span>
            </h2>
          </div>
        </Container>

        <Container fluid className="footerBottomFluid">
          <div className="footerBottomBar">
            <div className="footerSocials" aria-label="Social links">
              <a className="footerSocial" href="https://www.instagram.com/purplecrunchrecords?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw%3D%3D" target="_blank" rel="noopener noreferrer">
                <InstaIcon />
              </a>
              <a className="footerSocial" href="https://www.tiktok.com/@purplecrunchrecords?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer">
                <TikTokIcon />
              </a>
              <a className="footerSocial" href="https://open.spotify.com/" target="_blank" rel="noopener noreferrer">
                <SpotifyIcon />
              </a>
              <a className="footerSocial" href="https://youtube.com/" target="_blank" rel="noopener noreferrer">
                <YouTubeIcon />
              </a>
            </div>

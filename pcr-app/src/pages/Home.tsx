...
export default function Home({ isActive = true }: Props) {
  ...
  return (
    <section className={cls} style={{ animationDuration: "650ms" }} id="hero">
      ...
      <div className="hero-content hero-content--lower">
        <h1 className="hero-title">
          <span className="hero-title-line">
            <span className="hero-title-light">{hero.titleLight}</span>{" "}
        ...
        <p className="hero-sub">
          {(hero.subLines?.length ? hero.subLines : DEFAULT_HERO.subLines).map((line, i) => (

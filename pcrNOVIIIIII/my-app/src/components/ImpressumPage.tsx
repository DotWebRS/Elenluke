...
import "../style/ImpressumPage.css";
      ...
      <section className="impressum-page">
        ...
        <Container className="impressum-page__container">
          ...
          <div className="impressum-page__hero">
            <h1 className="impressum-main-title">
              <span className="impressum-main-title__white">IMPRES</span>
              <span className="impressum-main-title__grad">SUM</span>
            </h1>
